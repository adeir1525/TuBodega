        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="brand_title" class="form-control" placeholder="Ingresar nombre de la marca">
		        	</div>
        		</div>
        		<input type="hidden" name="add_brand" value="1">
        		<div class="col-12">
        			<button type="button" class="btn btn-warning add-brand">Agregar Marca</button>
        		</div>
        	</div>
        ...
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nombre de la Marca</label>
                <input type="text" name="e_brand_title" class="form-control" placeholder="Ingresar nombre de la marca">
              </div>
            </div>
