						...
						<div class="navbar navbar-inverse navbar-fixed-top">
							<div class="container-fluid">	
								<div class="navbar-header">
									<a href="#" class="navbar-brand">Tu Bodega</a>
								</div>
								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Gracias </h1>
											<hr/>
											<p>Hola<?php echo "<b>".$_SESSION["name"]."</b>"; ?>,Su proceso de pago es completado con éxito y su ID de transacción es <b><?php echo $trx_id; ?></b><br/>
